...
import com.kalathoki.learning.batchpartitioning.partition.ColumnRangePartitioner;
 ...
 * @created on:- 08 Jul, 2022 at 5:24 PM
 */
...
public class SpringBatchPartitionConfig {
    ...
    @Bean
    public Job runJob() {
        return jobBuilderFactory.get("saveCustomer")
